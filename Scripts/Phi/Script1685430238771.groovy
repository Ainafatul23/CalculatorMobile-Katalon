...
Mobile.tap(findTestObject('Calculator/Detail - More Operation/Phi - Button'), 0)

String Phi = Mobile.getText(findTestObject('Calculator/Detail - More Operation/Phi - Button'), 0)

String Value = Number + Phi
...
double PhiResult = ValNumber * Math.PI

double roundedResult = (double) (Math.round(PhiResult * 1_000_000_000.0) / 1_000_000_000.0)
