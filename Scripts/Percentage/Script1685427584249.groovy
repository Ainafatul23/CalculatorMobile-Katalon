...
String FirstNumber = Mobile.getText(findTestObject('Calculator/Number/7 - Button'), 0)

Mobile.verifyElementText(findTestObject('Calculator/Cal/Cal - Text View'), FirstNumber)

Mobile.tap(findTestObject('Calculator/Operation/Percent - Button'), 0)

String Percent = Mobile.getText(findTestObject('Calculator/Operation/Percent - Button'), 0)

String PerValue = FirstNumber + Percent

Mobile.verifyElementText(findTestObject('Calculator/Cal/Cal - Text View'), PerValue)

Mobile.tap(findTestObject('Calculator/Cal/Equals - Button'), 0)

double first_number = FirstNumber.toDouble()

double PerResult = first_number / 100

String ExpectedValue = PerResult.toString()
