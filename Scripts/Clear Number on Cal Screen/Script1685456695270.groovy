...
Mobile.tap(findTestObject('Calculator/Cal/Clear - Button'), 0)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Value2 = Mobile.getText(findTestObject('Calculator/Cal/Cal - Text View'), 0)

Mobile.verifyNotMatch(Value, Value2, false)
