...
String FirstNumber = Mobile.getText(findTestObject('Calculator/Number/1 - Button'), 0)
...
String AddValue = FirstNumber + Plus

Mobile.verifyElementText(findTestObject('Calculator/Cal/Cal - Text View'), AddValue)
...
String Value = AddValue + SecondNumber
...
int AddResult = first_number + second_number

String ExpectedValue = AddResult.toString()
