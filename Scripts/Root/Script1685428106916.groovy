...
Mobile.tap(findTestObject('Calculator/Detail - More Operation/Root - Button'), 0)

String Root = Mobile.getText(findTestObject('Calculator/Detail - More Operation/Root - Button'), 0)

Mobile.verifyElementText(findTestObject('Calculator/Cal/Cal - Text View'), Root)

Mobile.tap(findTestObject('Calculator/Number/9 - Button'), 0)

String Number = Mobile.getText(findTestObject('Calculator/Number/9 - Button'), 0)

String Value = Root + Number
...
double RootResult = Math.sqrt(ValNumber)

String ExpectedValue = RootResult.toString()
